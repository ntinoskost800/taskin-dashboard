...
const ColumnCard: FC<ColumnCardProps> = ({
  ...
  const [showCreateTask, setShowCreateTask] = useState(false) // State to control CreateTask modal
  ...
  // Handler for the + button - now opens CreateTask modal
    ...
    <>
      ...
      {showCreateTask && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white p-6 dark:bg-metal-900">
            <CreateTask onOpenChange={setShowCreateTask} />
          </div>
        </div>
      )}
    </>
